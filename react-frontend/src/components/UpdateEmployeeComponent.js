...
class UpdateEmployeeComponent extends Component {
  ...
  updateEmployee(e) {
    ...
    EmployeeService.updateEmployee(this.state.id, updatedEmployee).then((res) => {
              ...
              <div className='card-body'>
                <form>
                  ...
                  >
                   ...
                   <button className='btn btn-success' onClick={this.updateEmployee} style={{marginTop:'20px'}}>save</button>
